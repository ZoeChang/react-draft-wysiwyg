...
describe('Editor test suite', function () {
  it('should have a div when rendered', function () {
    (0, _chai.expect)((0, _enzyme.shallow)(_react2.default.createElement(_2.default, null)).html().startsWith('<div')).to.be.true;
  });
  ...
  it('should not have toolbar if toolbarHidden is set to true', function () {
    var editor = (0, _enzyme.shallow)(_react2.default.createElement(_2.default, { toolbarHidden: true }));
    (0, _chai.expect)(editor.find('.rdw-editor-toolbar')).to.have.length(0);
  });
});