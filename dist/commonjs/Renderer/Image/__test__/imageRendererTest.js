...
describe('ImageRenderer test suite', function () {
  ...
  it('should have a div when rendered', function () {
    var Image = (0, _index2.default)({ isReadOnly: function isReadOnly() {
        return false;
      }, isImageAlignmentEnabled: function isImageAlignmentEnabled() {
        return true;
      } });
    (0, _chai.expect)((0, _enzyme.shallow)(_react2.default.createElement(Image, { block: (0, _draftjsUtils.getAllBlocks)(newEditorState).get(1), contentState: contentState })).node.type).to.equal('span');
  });
